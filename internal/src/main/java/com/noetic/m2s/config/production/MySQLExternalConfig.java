...
@ConfigurationProperties(ignoreUnknownFields = true, prefix = "production.external.mysql")
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = {
		"com.noetic.m2s.domain.external.repository" }, entityManagerFactoryRef = "entityManagerFactory")
public class MySQLExternalConfig extends JpaCommonConfig {
    ...
    @Override
    @Primary
    @Bean(name = "m2sAPI" + "DataSource" + "Production" + "External")
